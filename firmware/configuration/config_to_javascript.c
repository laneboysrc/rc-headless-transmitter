...
void CONFIG_dump_javascript_information(void)
{
    ...
    sync_printf("            live_t: {\n");
    sync_printf(t, "ST", SRC_IN_ST);
    sync_printf(t, "TH", SRC_IN_TH);
    sync_printf(t, "THR", SRC_IN_THR);
    sync_printf(t, "RUD", SRC_IN_RUD);
    sync_printf(t, "AIL", SRC_IN_AIL);
    sync_printf(t, "ELE", SRC_IN_ELE);
    sync_printf(t, "AUX", SRC_IN_AUX);
    sync_printf(t, "ST-DR", SRC_IN_ST_DR);
    sync_printf(t, "RUD-DR", SRC_IN_RUD_DR);
    sync_printf(t, "AIL-DR", SRC_IN_AIL_DR);
    sync_printf(t, "ELE-DR", SRC_IN_ELE_DR);
    sync_printf(t, "TH-DR", SRC_IN_TH_DR);
    sync_printf(t, "THR-DR", SRC_IN_THR_DR);
    sync_printf(t, "TH-HOLD", SRC_IN_TH_HOLD);
    sync_printf(t, "GEAR", SRC_IN_GEAR);
    sync_printf(t, "FLAPS", SRC_IN_FLAPS);
    sync_printf(t, "TRAINER", SRC_IN_TRAINER);
    sync_printf(t, "SIDE-L", SRC_IN_SIDE_L);
    sync_printf(t, "SIDE-R", SRC_IN_SIDE_R);
    sync_printf(t, "POT1", SRC_IN_POT1);
    sync_printf(t, "POT2", SRC_IN_POT2);
    sync_printf(t, "POT3", SRC_IN_POT3);
    sync_printf(t, "POT4", SRC_IN_POT4);
    sync_printf(t, "POT5", SRC_IN_POT5);
    sync_printf(t, "POT6", SRC_IN_POT6);
    sync_printf(t, "POT7", SRC_IN_POT7);
    sync_printf(t, "POT8", SRC_IN_POT8);
    sync_printf(t, "POT9", SRC_IN_POT9);
    sync_printf(t, "SW1", SRC_IN_SW1);
    sync_printf(t, "SW2", SRC_IN_SW2);
    sync_printf(t, "SW3", SRC_IN_SW3);
    sync_printf(t, "SW4", SRC_IN_SW4);
    sync_printf(t, "SW5", SRC_IN_SW5);
    sync_printf(t, "SW7", SRC_IN_SW7);
    sync_printf(t, "SW8", SRC_IN_SW8);
    sync_printf(t, "SW9", SRC_IN_SW9);
    sync_printf(t, "CH1", SRC_CH_CH1);
    sync_printf(t, "CH2", SRC_CH_CH2);
    sync_printf(t, "CH3", SRC_CH_CH3);
    sync_printf(t, "CH4", SRC_CH_CH4);
    sync_printf(t, "CH5", SRC_CH_CH5);
    sync_printf(t, "CH6", SRC_CH_CH6);
    sync_printf(t, "CH7", SRC_CH_CH7);
    sync_printf(t, "CH8", SRC_CH_CH8);
    sync_printf(t, "VIRTUAL1", SRC_CH_VIRTUAL1);
    sync_printf(t, "VIRTUAL2", SRC_CH_VIRTUAL2);
    sync_printf(t, "VIRTUAL3", SRC_CH_VIRTUAL3);
    sync_printf(t, "VIRTUAL4", SRC_CH_VIRTUAL4);
    sync_printf(t, "VIRTUAL5", SRC_CH_VIRTUAL5);
    sync_printf(t, "VIRTUAL6", SRC_CH_VIRTUAL6);
    sync_printf(t, "VIRTUAL7", SRC_CH_VIRTUAL7);
    sync_printf(t, "VIRTUAL8", SRC_CH_VIRTUAL8);
    sync_printf(t, "VIRTUAL9", SRC_CH_VIRTUAL9);
    sync_printf(t, "VIRTUAL10", SRC_CH_VIRTUAL10);
    sync_printf(t, "HIDDEN1", SRC_CH_HIDDEN1);
    sync_printf(t, "HIDDEN2", SRC_CH_HIDDEN2);
    sync_printf(t, "HIDDEN3", SRC_CH_HIDDEN3);
    sync_printf(t, "HIDDEN4", SRC_CH_HIDDEN4);
    sync_printf(t, "HIDDEN5", SRC_CH_HIDDEN5);
    sync_printf(t, "HIDDEN6", SRC_CH_HIDDEN6);
    sync_printf(t, "HIDDEN7", SRC_CH_HIDDEN7);
    sync_printf(t, "HIDDEN8", SRC_CH_HIDDEN8);
    sync_printf(t, "HIDDEN9", SRC_CH_HIDDEN9);
    sync_printf(t, "HIDDEN10", SRC_CH_HIDDEN10);
    sync_printf(t, "HIDDEN11", SRC_CH_HIDDEN11);
    sync_printf(t, "HIDDEN12", SRC_CH_HIDDEN12);
    sync_printf(t, "HIDDEN13", SRC_CH_HIDDEN13);
    sync_printf(t, "HIDDEN14", SRC_CH_HIDDEN14);
    sync_printf(t, "HIDDEN15", SRC_CH_HIDDEN15);
    sync_printf(t, "HIDDEN16", SRC_CH_HIDDEN16);
    sync_printf(t, "HIDDEN17", SRC_CH_HIDDEN17);
    sync_printf(t, "HIDDEN18", SRC_CH_HIDDEN18);
    sync_printf(t, "HIDDEN19", SRC_CH_HIDDEN19);
    sync_printf(t, "HIDDEN20", SRC_CH_HIDDEN20);
    sync_printf(t, "HIDDEN21", SRC_CH_HIDDEN21);
    sync_printf(t, "HIDDEN22", SRC_CH_HIDDEN22);
    sync_printf(t, "HIDDEN23", SRC_CH_HIDDEN23);
    sync_printf(t, "HIDDEN24", SRC_CH_HIDDEN24);
    sync_printf(t, "HIDDEN25", SRC_CH_HIDDEN25);
    sync_printf(t, "HIDDEN26", SRC_CH_HIDDEN26);
    sync_printf(t, "HIDDEN27", SRC_CH_HIDDEN27);
    sync_printf(t, "HIDDEN28", SRC_CH_HIDDEN28);
    sync_printf(t, "HIDDEN29", SRC_CH_HIDDEN29);
    sync_printf(t, "HIDDEN30", SRC_CH_HIDDEN30);
    sync_printf(t, "HIDDEN31", SRC_CH_HIDDEN31);
    sync_printf(t, "HIDDEN32", SRC_CH_HIDDEN32);
    sync_printf(t, "HIDDEN33", SRC_CH_HIDDEN33);
    sync_printf(t, "HIDDEN34", SRC_CH_HIDDEN34);
    sync_printf(t, "HIDDEN35", SRC_CH_HIDDEN35);
    sync_printf(t, "HIDDEN36", SRC_CH_HIDDEN36);
    sync_printf(t, "HIDDEN37", SRC_CH_HIDDEN37);
    sync_printf(t, "HIDDEN38", SRC_CH_HIDDEN38);
    sync_printf(t, "HIDDEN39", SRC_CH_HIDDEN39);
    sync_printf(t, "HIDDEN40", SRC_CH_HIDDEN40);
    sync_printf(t, "HIDDEN41", SRC_CH_HIDDEN41);
    sync_printf(t, "HIDDEN42", SRC_CH_HIDDEN42);
    sync_printf(t, "HIDDEN43", SRC_CH_HIDDEN43);
    sync_printf(t, "HIDDEN44", SRC_CH_HIDDEN44);
    sync_printf(t, "HIDDEN45", SRC_CH_HIDDEN45);
    sync_printf(t, "HIDDEN46", SRC_CH_HIDDEN46);
    sync_printf(t, "HIDDEN47", SRC_CH_HIDDEN47);
    sync_printf(t, "HIDDEN48", SRC_CH_HIDDEN48);
    sync_printf(t, "HIDDEN49", SRC_CH_HIDDEN49);
    sync_printf(t, "HIDDEN50", SRC_CH_HIDDEN50);
    sync_printf(t, "RF-CH1", SRC_RF_CH1);
    sync_printf(t, "RF-CH2", SRC_RF_CH2);
    sync_printf(t, "RF-CH3", SRC_RF_CH3);
    sync_printf(t, "RF-CH4", SRC_RF_CH4);
    sync_printf(t, "RF-CH5", SRC_RF_CH5);
    sync_printf(t, "RF-CH6", SRC_RF_CH6);
    sync_printf(t, "RF-CH7", SRC_RF_CH7);
    sync_printf(t, "RF-CH8", SRC_RF_CH8);
    sync_printf(t, "Battery (mV)", SRC_BATTERY_MV);
    sync_printf(t, "ADC0 (raw)", ADC0_RAW);
    sync_printf(t, "ADC1 (raw)", ADC1_RAW);
    sync_printf(t, "ADC2 (raw)", ADC2_RAW);
    sync_printf(t, "ADC3 (raw)", ADC3_RAW);
    sync_printf(t, "ADC4 (raw)", ADC4_RAW);
    sync_printf(t, "ADC5 (raw)", ADC5_RAW);
    sync_printf(t, "ADC6 (raw)", ADC6_RAW);
    sync_printf(t, "ADC7 (raw)", ADC7_RAW);
    sync_printf(t, "ADC8 (raw)", ADC8_RAW);
    sync_printf(t, "ADC9 (raw)", ADC9_RAW);
    sync_printf(t, "ADC10 (raw)", ADC10_RAW);
    sync_printf(t, "ADC11 (raw)", ADC11_RAW);
    sync_printf(t, "ADC12 (raw)", ADC12_RAW);
    sync_printf(t, "ADC13 (raw)", ADC13_RAW);
    sync_printf(t, "ADC14 (raw)", ADC14_RAW);
    sync_printf(t, "ADC15 (raw)", ADC15_RAW);
    sync_printf(t, "ADC16 (raw)", ADC16_RAW);
    sync_printf(t, "ADC17 (raw)", ADC17_RAW);
    sync_printf(t, "ADC18 (raw)", ADC18_RAW);
    sync_printf(t, "ADC19 (raw)", ADC19_RAW);
    sync_printf(t, "ADC20 (raw)", ADC20_RAW);
    sync_printf(t, "ADC21 (raw)", ADC21_RAW);
    sync_printf(t, "ADC22 (raw)", ADC22_RAW);
    sync_printf(t, "ADC23 (raw)", ADC23_RAW);
    sync_printf(t, "ADC24 (raw)", ADC24_RAW);
    sync_printf(t, "ADC25 (raw)", ADC25_RAW);
    sync_printf(t, "ADC26 (raw)", ADC26_RAW);
    sync_printf(t, "ADC27 (raw)", ADC27_RAW);
    sync_printf(t, "ADC28 (raw)", ADC28_RAW);
    sync_printf(t, "ADC29 (raw)", ADC29_RAW);
    sync_printf(t, "ADC30 (raw)", ADC30_RAW);
    sync_printf(t, "ADC31 (raw)", ADC31_RAW);
    sync_printf("            },\n");
